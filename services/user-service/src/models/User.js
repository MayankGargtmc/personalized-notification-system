...
let User = (() => {
    ...
    var User = _classThis = class {
        constructor() {
            ...
            this.preferences = (__runInitializers(this, _password_extraInitializers), __runInitializers(this, _preferences_initializers, void 0));
    ...
    (() => {
        ...
        _preferences_decorators = [(0, typeorm_1.Column)("simple-array")];
